...
async function getAll(req, res){
    try {
        const data = await ProveedorModels.getProovedores();
        res.json(data);
    } catch (error) {
...
async function getById(req, res){
    try {
        ...
        const data = await ProveedorModels.getProovedor(id)
...
async function create(req, res){
    try {
        await ProveedorModels.postProveedor(req.body);
...
async function update(req, res){
    try {
        const id = parseInt(req.params.id)
        await ProveedorModels.updateProveedor(id, req.body)
...
async function inactive(req, res){
    try {
        const id = parseInt(req.params.id)
        await ProveedorModels.inactiveProveedor(id)
